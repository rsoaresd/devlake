...
func Init(br context.BasicRes, p plugin.PluginMeta) {
	...
	dsHelper = api.NewDataSourceHelper[
		models.TestRegistryConnection, models.TestRegistryScope, models.TestRegistryScopeConfig,
	](
		br,
		p.Name(),
		[]string{"fullName"}, // Use fullName as unique identifier for scopes
		func(c models.TestRegistryConnection) models.TestRegistryConnection {
			return c // No sanitization needed for now
		},
		nil,
		nil,
	)
